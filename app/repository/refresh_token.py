...
class RefreshTokenRepository:
    ...
    async def insert_refresh_token(self, token: str, user_id: int) -> RefreshTokenSchema:
    ...
    async def get_refresh_token_by_user_id(self, user_id: int) -> RefreshTokenSchema | None:
